...
/**
  ...
  *
  * Return: If the val is not present or the array is NULL, -1.
...
/**
  ...
  * @size: The num of elems in the array.
  * @value: The val to search for.
  *
  * Return: If the val is not present or the arr is NULL, -1.
  *         Otherwise, the index where the value is located.
  *
  * Description: Prints a val every time it is compared in the arr.
  */
